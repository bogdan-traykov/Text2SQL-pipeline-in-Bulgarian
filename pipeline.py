...
DB_DATABASE: str = "Chinook" # Database name
DB_TABLES: List[str] = ["Artist","Track","Album"] # Tables to use
...
# Run the pipeline
response,intermidiates = qp.run_with_intermediates(query=user_input)



# Get the Final response prompt
synthesis_output = intermidiates["Final response LLM"].inputs['messages']   
# Get the Text2SQL prompt
prompt = intermidiates["Text2SQL LLM"].inputs['messages']
